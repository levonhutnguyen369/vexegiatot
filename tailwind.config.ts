...
import tailwindForms from "@tailwindcss/forms"       // 👇 Import plugin Forms mới tại đây
...
export default {
  ...
  // ... các cấu hình khác
  plugins: [
    tailwindcssAnimate,            // Plugin cũ của bạn (nhớ có dấu phẩy ở cuối dòng này)
    tailwindForms, // 👇 Thêm plugin mới vào đây
  ],
} satisfies Config;
