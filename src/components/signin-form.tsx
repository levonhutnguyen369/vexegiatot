...
export function SigninForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<SignInFormValue>({
    resolver: zodResolver(signInSchema) // quy dinh validate logic cho form
  });
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-8 text-center">
              ...
              />
              <h2 className="mb-2 text-2xl font-bold">Đăng nhập</h2>
            ...
            {/* nut dang ky */}
            <div className="mt-6">
              <Button className="w-full bg-blue-500 hover:bg-blue-600" type="submit" disabled={isSubmitting}>Tiếp tục</Button>
            </div>
